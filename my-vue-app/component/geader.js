...
<div class="w-full h-16 bg-white max-w-screen-xl flex flex-wrap items-center mx-auto">
    <a href="./index.html">
        <img src="/my-vue-app/logos/Picsart_24-02-29_11-26-12-300.png" alt="">
    </a>
    <a href="/my-vue-app/page/categories.html"><button class="w-32 h-10 bg-violet-100 ml-6 rounded text-violet-600">
    ...
    <div id="buttons"
        ...
        <div class="relative inline-block">
          <button type="button" onclick="location.href='/my-vue-app/savat.html'"
            class="dropbtn ml-[20px] h-10 w-28 pl-[5px] pt-[10px] rounded text-gray-900 flex hover:bg-gray-200">
            <svg class="mr-[10px] mt-[-3px] text-gray-800" xmlns="http://www.w3.org/2000/svg" width="26" height="26"
          ...
          <div class="hidden absolute bg-[#f1f1f1] z-1 ml-[-298px] w-[430px] h-[135px]">
            <div class="">
              <button class="w-full h-[67.5px] bg-white flex text-left pt-[13px] hover:bg-[#f1f1f1]">
                <img class="w-[30px] h-[42.5px] ml-[10px]"
                  src="https://images.uzum.uz/cne3or1s99ouqb804fsg/original.jpg" alt="">
                <div class="pl-[10px]">
                  <p class="text-gray-600">Kunga boqar yogi oyila tanlovi, tozalangan va ...</p>
                  <lord-icon class="ml-[320px]" src="https://cdn.lordicon.com/wpyrrmcq.json" trigger="hover"
                    style="width:15px;height:15px">
                  </lord-icon>
                  <p class=" text-[12px]">9 000 som</p>
                </div>
              </button>



              <button class="w-[390px] h-[40px] bg-indigo-500 ml-[20px] mt-[13.5px] text-white hover:bg-indigo-600"
                id="openModalButton2">Buyutmani rasmiylashtirish</button>
